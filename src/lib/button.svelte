<script lang="ts">
    export let color: `#${string}` = "#1ed760"
...
<button on:click={handleClick} class="main-repeatButton-button" role="checkbox" aria-checked="false" aria-label="Svelte is alive"
        style="--button-size:32px; --this-button-color: {color}" aria-expanded="false">
    <svg viewBox="0 0 98.1 118" height="16px" width="16px">
