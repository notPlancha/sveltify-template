...
(async () => {
    if (!document.getElementById(`sveltify`)) {
      var el = document.createElement('style');
      el.id = `sveltify`;
      el.textContent = (String.raw`
  /* fakecss:C:/Users/Plancha/Desktop/sveltify-template/src/lib/button.esbuild-svelte-fake-css */
.st0.svelte-112gkba {
  fill: var(--this-button-color);
}
.st1.svelte-112gkba {
  fill: white;
}
